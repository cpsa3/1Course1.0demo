...
businesscomponents.NewMyJwplay = function(opt_html) {
    var _this = this;
    this._audioContainer = (Math.random() * (0 - 100) + 100).toString();
    businesscomponents.NewMyJwplay.superClass.constructor.call(this, $(opt_html !== undefined ? opt_html : businesscomponents.NewMyJwplay.html(this._audioContainer))[0]);
    //完成回调
    this._compCall = null;
    this._audioId = 0;
...
toot.inherit(businesscomponents.NewMyJwplay, toot.ui.Component);
toot.defineEvent(businesscomponents.NewMyJwplay, ["playCountChange", "fistPlay", "playAudio"]);
toot.extendClass(businesscomponents.NewMyJwplay, {
    ...
    _updateTotalTime: function() {
        ...
        this.totalTimer = setInterval(function() {
            if (jwplayer(_this._audioContainer) && jwplayer(_this._audioContainer).getDuration() > 0) {
...
businesscomponents.NewMyJwplay.html = function(audioContainer) {
