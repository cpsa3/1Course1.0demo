/*
* 功能:SAT阅读 - 文章阅读选择题组 ，比选择题组多select控件
* 作者:小潘
* 日期:2014年3月7日 11:00:35
*/
...
businesscomponents.editors.readingquestion = businesscomponents.editors.readingquestion || {};

businesscomponents.editors.readingquestion.Choice = function (opt_html) {
    businesscomponents.editors.readingquestion.Choice.superClass.constructor.call(this, $(opt_html !== undefined ? opt_html : businesscomponents.editors.readingquestion.Choice.html)[0]);
...
toot.inherit(businesscomponents.editors.readingquestion.Choice, toot.view.Item);
toot.extendClass(businesscomponents.editors.readingquestion.Choice, {

    _init_manageEvents: function () {
        businesscomponents.editors.readingquestion.Choice.superClass._init_manageEvents.call(this);
    ...
    _render: function () {
        businesscomponents.editors.readingquestion.Choice.superClass._render.call(this);
    ...
    updateModelByUI: function () {
        if (!this._model) this._model = new models.components.readingquestion.Choice();
...
businesscomponents.editors.readingquestion.Choice.html =
...
businesscomponents.editors.readingquestion.QuestionGroup = function (opt_html) {
    businesscomponents.editors.readingquestion.QuestionGroup.superClass.constructor.call(this, $(opt_html !== undefined ? opt_html : businesscomponents.editors.readingquestion.QuestionGroup.html)[0]);
    ...
    //    this._rtTitle.setConfigFile('/content3/Scripts/ckeditorconfigs/readingquestion.js');
    ...
    //    this._rtQuestionTitle.setConfigFile('/content3/Scripts/ckeditorconfigs/readingquestion.js');
    //雅思听力&阅读 选择题题干 可增加图片
    ...
    //                       businesscomponents.editors.readingquestion.Choice, models.components.readingquestion.Choice, [this._$validation_atLeastOneChoiceSelected[0]]);
    //    this._listChoice.setBtnAdd(new toot.ui.Button($(this._element).find('[gi~="listChoice-btnAddChoice"]')[0]));
    this._listChoice = new businesscomponents.editors.readingquestion.ChoiceList();
    ...
    //select box
    this._$selectBox = $(this._element).find('[gi~="selectBox"]');

    this._select = new businesscomponents.Select(businesscomponents.Select.readingQuestionHtml);
    this._select.setUnselectedText("对比文章");
    this._select.appendTo(this._$selectBox[0]);

    // select 添加数组  ? xp
    var option = new businesscomponents.Option();
    var option1 = new businesscomponents.Option();

    option.setText("对比文章");
    this._select.add(option);
    option1.setText("独立文章");
    this._select.add(option1);
...
toot.inherit(businesscomponents.editors.readingquestion.QuestionGroup, toot.view.ViewBase);
toot.extendClass(businesscomponents.editors.readingquestion.QuestionGroup, {
    ...
    _init_manageEvents: function () {
        businesscomponents.editors.readingquestion.QuestionGroup.superClass._init_manageEvents.call(this);
        ...
        toot.connect(this._select, "change", this, this._onSelectChange);
    },
    _init_render: function () {
        businesscomponents.editors.readingquestion.QuestionGroup.superClass._init_render.call(this);
    ...
    updateUIByModel: function () {
        if (this._model) {
            ...
            //定位选项
            this._select.setSelectedIndex(this._model.getType());
    ...
    updateModelByUI: function () {
        if (!this._model) this._model = new models.components.readingquestion.QuestionGroup();
    ...
    _onTabsBeforeAddOrSwitch: function (sender, e) {
        ...
        if (!result) {
            ...
            this._currentValidatedFalseModel = new models.components.readingquestion.Question();
            ...
            if (question.getChoices()) {
                ...
                for (var i = 0, l = question.getChoices().length; i < l; i++) {
                    var choice = new models.components.readingquestion.Choice();
    ...
    _onSelectChange:function(sender,e) {
        if (!this._model) this._model = new models.components.readingquestion.QuestionGroup();
        this._model.setType(sender._selectedIndex);
    },
    ...
    _onTabsAdd: function () {
        ...
        var question = new models.components.readingquestion.Question();
        question.setChoices([]);
        for (var i = 0; i < this.getChoiceCountWhenTabAdds(); i++) {
            question.getChoices().push(new models.components.readingquestion.Choice());
        }
...
businesscomponents.editors.readingquestion.QuestionGroup.html =
                                                      '<div>' +
                                                        '<div gi="anchorTitle"></div><div class="marB10 clearfix" gi="selectBox"></div><div gi="anchorTabs"></div><div gi="anchorQuestionTitle"></div>' +
                                                        '<div gi="listChoice">' +
                                                        '</div>' +
                                                      '</div>';
...
businesscomponents.editors.readingquestion.ChoiceList = function (opt_html) {
    businesscomponents.editors.readingquestion.ChoiceList.superClass.constructor.call(this, $(opt_html !== undefined ? opt_html : businesscomponents.editors.readingquestion.ChoiceList.html)[0], null,
                      businesscomponents.editors.readingquestion.Choice, models.components.readingquestion.Choice, null);
...
toot.inherit(businesscomponents.editors.readingquestion.ChoiceList, toot.view.List);
toot.extendClass(businesscomponents.editors.readingquestion.ChoiceList, {

    _init_render: function () {
        businesscomponents.editors.readingquestion.ChoiceList.superClass._init_render.call(this);
        this.removeValidationInfo();
    },

    _initializeItem: function () {
        var item = businesscomponents.editors.readingquestion.ChoiceList.superClass._initializeItem.call(this);
    ...
    _disposeItem: function (item) {
        ...
        businesscomponents.editors.readingquestion.ChoiceList.superClass._disposeItem.call(this, item);
    },
    ...
    updateUIByModel: function () {
        businesscomponents.editors.readingquestion.ChoiceList.superClass.updateUIByModel.call(this);
...
businesscomponents.editors.readingquestion.ChoiceList.html = '<div>' +
...
businesscomponents.editors.readingquestion.Question = function (opt_html) {
    businesscomponents.editors.readingquestion.Question.superClass.constructor.call(this, $(opt_html !== undefined ? opt_html : businesscomponents.editors.readingquestion.Question.html)[0]);
...
toot.inherit(businesscomponents.editors.readingquestion.Question, toot.view.ViewBase);
toot.extendClass(businesscomponents.editors.readingquestion.Question, {
    updateUIByModel: function () {
        if (this._model) {
    ...
    updateModelByUI: function () {
        if (!this._model) this._model = new models.components.readingquestion.Question();
...
businesscomponents.editors.readingquestion.Question.html = '<div></div>'; 