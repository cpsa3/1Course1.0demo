...
* 功能:SAT数学选择题 做题页面UI
* 作者:xiaobao
* 参考来源于：choicequestionforsat.ui.js
* 
*/
...
businesscomponents.choicequestionForSATMaths = businesscomponents.choicequestionForSATMaths || {};

businesscomponents.choicequestionForSATMaths.ui = {};



businesscomponents.choicequestionForSATMaths.ui.ChoiceMode = {
    Single: 1,
    Multi: 2
};

//display 
businesscomponents.choicequestionForSATMaths.ui.display = {};
//需要渲染选项的图片
businesscomponents.choicequestionForSATMaths.ui.display.Choice = function (opt_html) {
    businesscomponents.ui.RnRItem.call(this, $(opt_html !== undefined ? opt_html : businesscomponents.choicequestionForSATMaths.ui.display.Choice.HTML)[0]);
    ...
    //choiceModel -》 businesscomponents.choicequestionForSATMaths.ui.ChoiceMode  
    this._choiceMode = -1;

    //if (this.constructor == arguments.callee) this._init();
};
toot.inherit(businesscomponents.choicequestionForSATMaths.ui.display.Choice, businesscomponents.ui.RnRItem);
toot.extendClass(businesscomponents.choicequestionForSATMaths.ui.display.Choice, {
    updateUIByModel: function () {
        ...
        //设置选项内容,
        //渲染图片
        if (this.getRequestModel().getImgId() != 0) {
            //ajax
            var _this = this;
            var itemImg = $('<img src="" />');
            $.ajax({
                url: "/Common/GetShortUrl?id=" + _this.getRequestModel().getImgId(),
                type: 'GET',
                dataType: 'json',
                cache: false,
                success: function (json) {
                    itemImg.attr("src", json.url);
                    $(_this._choiceText).html(_this.getRequestModel().getContent().replace(String.fromCharCode(0x25E9), itemImg.get(0).outerHTML));
                }
            });
        }
        else {
    ...
    updateModelByUI: function () {
        ...
        if (this.getChoiceMode() == businesscomponents.choicequestionForSATMaths.ui.ChoiceMode.Single) {
        ...
        } else if (this.getChoiceMode() == businesscomponents.choicequestionForSATMaths.ui.ChoiceMode.Multi) {
    ...
    _setChoiceMode: function (mode) {
        ...
        if (this._choiceMode == businesscomponents.choicequestionForSATMaths.ui.ChoiceMode.Single) {
...
businesscomponents.choicequestionForSATMaths.ui.display.Choice.HTML = '<tr><td class="style2"><span class="radioboxStyle" gi="choiceLi"></span><label gi="choiceTitle">A</label></td><td><span class="ChoiceStyle" gi="choiceText">dominance . . edible</span></td></tr>';
...
businesscomponents.choicequestionForSATMaths.ui.display.ChoiceList = function (opt_html) {
    var choiceBoxElement = $(opt_html !== undefined ? opt_html : businesscomponents.choicequestionForSATMaths.ui.display.ChoiceList.HTML)[0];
    businesscomponents.choicequestionForSATMaths.ui.display.ChoiceList.superClass.constructor.call(this, choiceBoxElement, choiceBoxElement, businesscomponents.choicequestionForSATMaths.ui.display.Choice, businesscomponents.choicequestion.model.QuestionResponse);
    this._inAnswerCount = 0;
};
toot.inherit(businesscomponents.choicequestionForSATMaths.ui.display.ChoiceList, businesscomponents.ui.List);
//define event 
toot.defineEvent(businesscomponents.choicequestionForSATMaths.ui.display.ChoiceList, ["change", "beforeChange"]);
toot.extendClass(businesscomponents.choicequestionForSATMaths.ui.display.ChoiceList, {
    //init  Item   
    _createItem: function () {
        var item = businesscomponents.choicequestionForSATMaths.ui.display.ChoiceList.superClass._createItem.call(this);
        //click event 
        toot.connect(item, "click", this, this._onItemClick);
        //        $(item.getElement()).bind("click", this._onItemClick);
        item.setChoiceMode((this.getRadioMode()) ?
            businesscomponents.choicequestionForSATMaths.ui.ChoiceMode.Single : businesscomponents.choicequestionForSATMaths.ui.ChoiceMode.Multi);
    ...
    updateUIByModel: function () {
        //判断是否单选
        this.initRadioMode();
        businesscomponents.choicequestionForSATMaths.ui.display.ChoiceList.superClass.updateUIByModel.call(this);
    ...
    _disposeItem: function (item) {
        ...
        businesscomponents.choicequestionForSATMaths.ui.display.ChoiceList.superClass._disposeItem.call(this, item);
    },
    //单击事件 
...
businesscomponents.choicequestionForSATMaths.ui.display.ChoiceList.HTML1 = '<ul class="L2answerchoicebox2" gi="choiceBox"></ul>';
businesscomponents.choicequestionForSATMaths.ui.display.ChoiceList.HTML = '<table border="0" cellpadding="0" cellspacing="0" class="fontn" gi="choiceBox"></table>';


//extendClass -> businesscomponents.ui.RnRItem  注入ChoiceList
businesscomponents.choicequestionForSATMaths.ui.display.Question = function (opt_html) {
    businesscomponents.ui.RnRItem.call(this, $(opt_html !== undefined ? opt_html : businesscomponents.choicequestionForSATMaths.ui.display.Question.HTML)[0]);
    ...
    this._listChoice = new businesscomponents.choicequestionForSATMaths.ui.display.ChoiceList(this._choiceBox);


};


toot.inherit(businesscomponents.choicequestionForSATMaths.ui.display.Question, businesscomponents.ui.RnRItem);
//define event 
toot.defineEvent(businesscomponents.choicequestionForSATMaths.ui.display.Question, ["change", "beforeChange"]);
toot.extendClass(businesscomponents.choicequestionForSATMaths.ui.display.Question, {
    updateUIByModel: function () {
        if (!this.getRequestModel()) {
            throw businesscomponents.ui.Exception.MODEL_INPUT_ERR;
        }
...
businesscomponents.choicequestionForSATMaths.ui.display.Question.HTML1 = '<div class="listenbox2">' +
    '<!--题干 {-->' +
...
//静态DOM  -》 对应v1.4版
businesscomponents.choicequestionForSATMaths.ui.display.Question.HTML = '<li>' +
    '<!--题干 {-->' +
...
businesscomponents.choicequestionForSATMaths.ui.display.QuestionGroup = function (opt_html) {

    businesscomponents.ui.BusinessComponentBase.call(this, $(opt_html !== undefined ? opt_html : businesscomponents.choicequestionForSATMaths.ui.display.QuestionGroup.html)[0]);
    ...
    this._listQuestion = new businesscomponents.ui.List(this._element, this._element,
        businesscomponents.choicequestionForSATMaths.ui.display.Question, businesscomponents.choicequestion.model.Question);
...
toot.inherit(businesscomponents.choicequestionForSATMaths.ui.display.QuestionGroup, businesscomponents.ui.BusinessComponentBase);
//define event 
toot.defineEvent(businesscomponents.choicequestionForSATMaths.ui.display.QuestionGroup, ["change", "beforechange"]);

toot.extendClass(businesscomponents.choicequestionForSATMaths.ui.display.QuestionGroup, {
    updateUIByModel: function () {
        if (!this.getRequestModel())
            throw businesscomponents.ui.Exception.MODEL_INPUT_ERR;
    ...
    _generatorQuestion: function () {
        var uiQuestion = new businesscomponents.choicequestionForSATMaths.ui.display.Question();
...
businesscomponents.choicequestionForSATMaths.ui.display.QuestionGroup.html = '<ol gi="choiceList" class="questionListOl"></ol>';
