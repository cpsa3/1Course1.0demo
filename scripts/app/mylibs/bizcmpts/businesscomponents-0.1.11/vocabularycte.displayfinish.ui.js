...
* 功能:中译英 报告、做题完成查看
* 作者:小潘
* 日期：2014年10月11日 16:15:24
*/

var businesscomponents = businesscomponents || {};

businesscomponents.vocabularycte = businesscomponents.vocabularycte || {};

businesscomponents.vocabularycte.ui = businesscomponents.vocabularycte.ui || {};

businesscomponents.vocabularycte.ui.displayfinish = businesscomponents.vocabularycte.ui.displayfinish || {};

businesscomponents.vocabularycte.ui.displayfinish.Question = function (optHtml) {

    toot.ui.Component.call(this, $(optHtml !== undefined ? optHtml : businesscomponents.vocabularycte.ui.displayfinish.Question.HTML)[0]);
...
toot.inherit(businesscomponents.vocabularycte.ui.displayfinish.Question, toot.ui.Component);


//可尝试用List渲染
toot.extendClass(businesscomponents.vocabularycte.ui.displayfinish.Question, {
    updateUIByModel: function () {
        if (this._answers.getAnswers() && this._questions && (this._questions.length == this._answers.getAnswers().length)) {
            ...
            for (var i = 0; i < this._questions.length; i++) {
                ...
                var answerBox = new businesscomponents.vocabularycte.ui.displayfinish.Question.AnswerBox();
                //题目
                answerBox._$question.text(this._questions[i].getChineseWord());
                //参考答案
                answerBox._$reference.text(this._questions[i].getEnglishWord()); 
                //您的答案
...
businesscomponents.vocabularycte.ui.displayfinish.Question.HTML = '<div>' +
...
businesscomponents.vocabularycte.ui.displayfinish.Question.AnswerBox = function (optHtml) {

    toot.ui.Component.call(this, $(optHtml !== undefined ? optHtml : businesscomponents.vocabularycte.ui.displayfinish.Question.AnswerBox.HTML)[0]);
...
//inherit toot.ui.Component
toot.inherit(businesscomponents.vocabularycte.ui.displayfinish.Question.AnswerBox, toot.ui.Component);

toot.extendClass(businesscomponents.vocabularycte.ui.displayfinish.Question.AnswerBox, {
    getAnswerBox: function () {
        return this.getElement();
    }
});

businesscomponents.vocabularycte.ui.displayfinish.Question.AnswerBox.HTML = '<dl gi="answerBox" class="questionbox10 clearfix ">' +
